...
## Final model
- Base HDBSCAN: `mcs=30`
- Selected `reduce_topics` target: **nr=90**
...
## Coder materials
- Review sheet: `topic_review_sheet_final_nr90.csv`
- Coder sheets: `coder1_sheet_final_nr90.csv`, `coder2_sheet_final_nr90.csv`
...
| `topic_post_diagnostics_final_nr90.csv` | Topic-by-post dominance |
