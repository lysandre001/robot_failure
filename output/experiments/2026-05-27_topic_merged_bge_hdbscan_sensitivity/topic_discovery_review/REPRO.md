...
## Final model
- Base HDBSCAN: `mcs=50`
- Selected `reduce_topics` target: **nr=85**
...
## Coder materials
- Review sheet: `topic_review_sheet_final_nr85.csv`
- Coder sheets: `coder1_sheet_final_nr85.csv`, `coder2_sheet_final_nr85.csv`
...
| `topic_post_diagnostics_final_nr85.csv` | Topic-by-post dominance |
